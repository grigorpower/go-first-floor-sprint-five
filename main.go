...
func (w Walking) Calories() float64 {
	...
	meanSpeed = math.Pow(meanSpeed, 2)
	heightInM := w.Height / 100
	return ((CaloriesWeightMultiplier*w.Weight + (meanSpeed/heightInM)*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()*MinInHours))
}
